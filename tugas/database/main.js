...
async function init (){
  const orm = new Sequelize(CONFIG.DATABASE, CONFIG.USERNAME, CONFIG.PASSWORD, CONFIG.DB_CONFIG);
...
async function writeData() {
    const A = await worker.create({ name: 'a' , alamat: 'jl bla',email: 'a.gmail.com', telp:'0851258',bio:'aku adalah A'});
    const B = await worker.create({ name: 'b' , alamat: 'jl ini',email: 'b.gmail.com', telp:'123456',bio:'aku adalah B'});
